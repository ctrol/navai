...
// 获取页脚设置
$footer_desc        = get_option('navai_footer_desc');
if (false === $footer_desc) {
	$footer_desc = esc_html__('发现AI，专业AI导航网站，一站式AI导航！', 'navai');
}
	...
	<footer class="site-footer">
		<div class="footer-container">
			...
			<div class="footer-copyright">
				...
				<?php else : ?>
				<span>Copyright &copy; <?php echo esc_html( date( 'Y' ) ); ?> <?php bloginfo('name'); ?></span>
				<?php endif; ?>
				<?php if ($footer_icp) : ?>
