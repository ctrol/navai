        ...
        <div class="detail-preview">
            <div class="detail-preview-body">
                ...
                <div class="detail-screenshot">
                    <?php if (!empty($website_url)) : ?>
                        <img src="https://s0.wp.com/mshots/v1/<?php echo esc_url($website_url); ?>?w=456&h=300" alt="<?php echo esc_attr(get_the_title()); ?>网页截图" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
