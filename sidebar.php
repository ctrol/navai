...
<div class="sidebar-collapsed-bar" id="sidebar-collapsed-bar" aria-label="<?php esc_attr_e('展开侧边栏', 'navai'); ?>">
	...
	<?php if ( ! empty($categories) && !is_wp_error($categories)) : ?>
		...
		<?php endforeach; ?>
	<?php endif; ?>
	<a href="<?php echo esc_url(home_url('/my-center/')); ?>" class="collapsed-bar-item" title="<?php esc_attr_e('我的', 'navai'); ?>">
...
<aside class="sidebar" role="complementary">
	...
	<div class="sidebar-actions">
		<a href="<?php echo esc_url(home_url('/my-center/')); ?>" class="sidebar-action-btn sidebar-action-my">
			<i data-lucide="heart"></i>
			<span><?php esc_html_e('我的', 'navai'); ?></span>
		</a>
